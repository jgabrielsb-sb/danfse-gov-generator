...
FIELD_SPECS: list[FieldSpec] = [
    ...
    FieldSpec("tributacao_municipal.tipo_tributacao_issqn", "tributacao_municipal", "TIPO DE TRIBUTAÇÃO DO ISSQN", 0.30, 14.43, 5.09, 0.63, 21),
    FieldSpec("tributacao_municipal.local_incidencia_uf_pais", "tributacao_municipal", "MUNICÍPIO / SIGLA UF / PAÍS DA INCIDÊNCIA DO ISSQN", 5.41, 14.43, 10.19, 0.63, 42),
